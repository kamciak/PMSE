package com.publicationmetasearchengine.gui.dialog;

import com.publicationmetasearchengine.gui.dialog.CheckboxConfirmDialog.Factory;
 ...
 *
 * @author Sami Ekblad
 * @see https://github.com/samie/Vaadin-ConfirmDialog
 * @author Kamil
 * 
 */
 ...
 *
 */
public class DefaultCheckboxConfirmDialogFactory implements Factory {
    ...
    @Override
    public CheckboxConfirmDialog create(final String caption, final String message,
            final String okCaption, final String cancelCaption) {

        // Create a confirm dialog
        final CheckboxConfirmDialog confirm = new CheckboxConfirmDialog();
        ...
        Button.ClickListener cb = new Button.ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                ...
                if (confirm.isEnabled()) {
                    ...
                    {
                        confirm.setSearchInArxiv(checkBoxArxiv.booleanValue());
                        confirm.setSearchInBwn(checkBoxBwn.booleanValue());
                        confirm.setSearchInWoK(checkBoxWoK.booleanValue());
        ...
        double[] dim = getDialogDimensions(message,
                CheckboxConfirmDialog.CONTENT_TEXT_WITH_NEWLINES);
    ...
    protected double[] getDialogDimensions(String message, int style) {
        ...
        if (style == CheckboxConfirmDialog.CONTENT_TEXT_WITH_NEWLINES) {
            rows += count("\n", message);
        }
