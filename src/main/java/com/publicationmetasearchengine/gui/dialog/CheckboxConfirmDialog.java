...
public class CheckboxConfirmDialog extends Window {
    ...
    public static CheckboxConfirmDialog.Factory getFactory() {
        if (factoryInstance == null) {
            factoryInstance = new DefaultCheckboxConfirmDialogFactory();
        }
    ...
    private boolean searchInBwn = true;
    private boolean searchInWoK = true;
